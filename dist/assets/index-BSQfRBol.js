import { j as jsx, c as _renderSSR, d as _pauseFromContexts, F as Fragment, s as setPlatform, e as componentQrl, q as qrl, b as __vitePreload, _ as _jsxC } from "./core.prod-DgySyvsF.js";
/**
 * @license
...
const Cmp = /* @__PURE__ */ componentQrl(/* @__PURE__ */ qrl(() => __vitePreload(() => import("./entry_component-tALj03vr.js"), true ? __vite__mapDeps([]) : void 0), "s_0WQh6CmOu1E"));
(async function() {
  document.head.appendChild(document.createElement("script")).text = getQwikLoaderScript({
    debug: true
  }) + "; console.log('I am alive')";
  const result = await renderToString(/* @__PURE__ */ _jsxC(Cmp, null, 3, "o0_0"), {
